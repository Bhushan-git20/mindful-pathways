...
export default function Resources() {
  ...
  const defaultResources = [
    ...
    {
      id: 'pro-1',
      title: 'APA Psychologist Locator',
      description: 'Find licensed psychologists',
      content: 'American Psychological Association directory to find verified, licensed mental health professionals.',
      category: 'Professional Help',
      external_url: 'https://locator.apa.org/',
      is_emergency: false,
      risk_band_target: null,
    },
    {
      ...
      content: 'Official U.S. government resource for finding substance abuse and mental health treatment facilities.',
      category: 'Professional Help',
      external_url: 'https://findtreatment.gov/',
      is_emergency: false,
      risk_band_target: null,
    },
    {
      ...
      content: 'Non-profit connecting individuals to affordable in-person and online mental health professionals.',
      category: 'Professional Help',
      external_url: 'https://openpathcollective.org/',
      is_emergency: false,
      risk_band_target: null,
    },
